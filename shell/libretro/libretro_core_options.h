...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   {
      CORE_OPTION_NAME "_coin_limit",
      "Coin Limit",
      NULL,
      "Disable coin insertion after defined limit.",
      NULL,
      "system",
      {
         { "0", "disabled" },
   ...
   },
   {
      ...
      NULL,
      "Choose where custom textures are preloaded at game start. System Memory reduces texture popping but uses more system memory. Video Memory preloads directly to the GPU and requires a supported renderer.",
      NULL,
      "hacks",
      {
         { "disabled",     "Off" },
