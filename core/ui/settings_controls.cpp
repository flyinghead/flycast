...
static constexpr Mapping dcButtons_src[] = {
	...
	{ DC_DPAD_UP, Tnop("DPad Up") },
	{ DC_DPAD_DOWN, Tnop("DPad Down") },
	{ DC_DPAD_LEFT, Tnop("DPad Left") },
	{ DC_DPAD_RIGHT, Tnop("DPad Right") },

	{ DC_AXIS_UP, Tnop("L.Thumbstick Up") },
	...
	{ DC_AXIS3_UP,    Tnop("Axis3 Up")    },
	{ DC_AXIS3_DOWN,  Tnop("Axis3 Down")  },
	{ DC_AXIS3_LEFT,  Tnop("Axis3 Left")  },
	{ DC_AXIS3_RIGHT, Tnop("Axis3 Right") },
	...
	{ EMU_BTN_LOADSTATE, Tnop("Load State (Current Slot)") },
	{ EMU_BTN_SAVESTATE, Tnop("Save State (Current Slot)") },
	...
	{ EMU_BTN_LOADSTATE_SLOT1, Tnop("Load State (Slot 1)") },
	{ EMU_BTN_SAVESTATE_SLOT1, Tnop("Save State (Slot 1)") },
	{ EMU_BTN_LOADSTATE_SLOT2, Tnop("Load State (Slot 2)") },
	{ EMU_BTN_SAVESTATE_SLOT2, Tnop("Save State (Slot 2)") },
	{ EMU_BTN_LOADSTATE_SLOT3, Tnop("Load State (Slot 3)") },
	{ EMU_BTN_SAVESTATE_SLOT3, Tnop("Save State (Slot 3)") },
	{ EMU_BTN_LOADSTATE_SLOT4, Tnop("Load State (Slot 4)") },
	{ EMU_BTN_SAVESTATE_SLOT4, Tnop("Save State (Slot 4)") },
	{ EMU_BTN_LOADSTATE_SLOT5, Tnop("Load State (Slot 5)") },
	{ EMU_BTN_SAVESTATE_SLOT5, Tnop("Save State (Slot 5)") },
	{ EMU_BTN_LOADSTATE_SLOT6, Tnop("Load State (Slot 6)") },
	{ EMU_BTN_SAVESTATE_SLOT6, Tnop("Save State (Slot 6)") },
	{ EMU_BTN_LOADSTATE_SLOT7, Tnop("Load State (Slot 7)") },
	{ EMU_BTN_SAVESTATE_SLOT7, Tnop("Save State (Slot 7)") },
	{ EMU_BTN_LOADSTATE_SLOT8, Tnop("Load State (Slot 8)") },
	{ EMU_BTN_SAVESTATE_SLOT8, Tnop("Save State (Slot 8)") },
	{ EMU_BTN_LOADSTATE_SLOT9, Tnop("Load State (Slot 9)") },
	{ EMU_BTN_SAVESTATE_SLOT9, Tnop("Save State (Slot 9)") },
	{ EMU_BTN_LOADSTATE_SLOT10, Tnop("Load State (Slot 10)") },
	{ EMU_BTN_SAVESTATE_SLOT10, Tnop("Save State (Slot 10)") },
