...
void ImGui_ImplDX9_UpdateTexture(ImTextureData* tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate)
    {
        ...
        // Store identifiers
        ImTextureDX9* tex_wrapper = new ImTextureDX9{dx_tex, false};
        tex->SetTexID((ImTextureID)tex_wrapper);
    ...
    else if (tex->Status == ImTextureStatus_WantUpdates)
    {
        ...
        const ImTextureDX9 *tex_wrapper = (const ImTextureDX9 *)tex->TexID;
        const LPDIRECT3DTEXTURE9 backend_tex = tex_wrapper->d3dTexture;
    ...
    {
        ImTextureDX9 *tex_wrapper = (ImTextureDX9 *)tex->TexID;
        if (tex_wrapper)
        {
            IM_ASSERT(tex_wrapper == (ImTextureDX9*)tex->TexID);
            tex_wrapper->d3dTexture->Release();
            tex_wrapper->d3dTexture = nullptr;
